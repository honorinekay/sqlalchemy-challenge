...
def home():
    ...
    return (
        ...
        f"note: start and end must be dates in YYYYMMDD format with start and end separated by '/'"
    )
...
def temp_output():
    """Return temperatures for the last year for most actice station"""
    ...
    # Return array of temperatures for last year for station USC00519281
